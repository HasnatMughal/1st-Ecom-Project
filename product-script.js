...
const prices = [
  12.99, 15.99, 10.99, 9.99, 12.99, 15.99, 10.99, 9.99, 12.99, 15.99, 10.99,
  9.99, 12.99, 15.99, 10.99, 7.99, 4.99, 5.99, 5.99,
];
...
let itemNo = 0;
const productItemNo = document.querySelector(".cart-item-num");
...
function addCartProduct(name, price) {
  ...
  removeBtn.addEventListener("click", function () {
    cartProduct.remove();
    let decr = --itemNo;
    productItemNo.textContent = decr;
    const removedPrice = parseFloat(productPrice.textContent);
    total -= removedPrice;
...
addToCartBtn.forEach((btn) =>
  btn.addEventListener("click", (event) => {
    ...
    let incr = ++itemNo;
    productItemNo.textContent = incr;
    // ##########################

    const priceInCart = parseFloat(productPriceForCart);
